        ...
        <main className="p-6 lg:p-8 space-y-8 max-w-7xl mx-auto w-full">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 bg-white p-4 rounded-2xl border border-slate-200 shadow-sm">
            ...
            <div className="flex items-center gap-2 w-full sm:w-auto">
              <Button variant="outline" size="sm" className="flex-1 sm:flex-none flex items-center gap-2">
                <Filter className="h-4 w-4" />
                Filters
              </Button>
              <select className="flex-1 sm:flex-none bg-white border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
