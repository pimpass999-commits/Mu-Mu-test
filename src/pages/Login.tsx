        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <div>
              ...
              <div className="mt-2 relative">
                ...
                <input
                  ...
                  className="block w-full rounded-xl border border-slate-200 bg-slate-50 py-3 pl-10 pr-4 text-slate-900 shadow-sm focus:ring-2 focus:ring-blue-600 focus:border-transparent sm:text-sm transition-all"
                />
              </div>
            </div>
          ...
          <div className="mt-10">
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              <button className="flex w-full items-center justify-center gap-3 rounded-xl bg-white px-3 py-2 text-sm font-semibold text-slate-900 shadow-sm ring-1 ring-inset ring-slate-200 hover:bg-slate-50 transition-all">
